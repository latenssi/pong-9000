...
function Update () {
  if (Time.time > nextPowerup)
  	...
  	randomNumber = Random.Range(1, powerup1rarity + powerup2rarity + powerup3rarity + powerup4rarity + 1);
    ...
    else if (randomNumber > powerup1rarity + powerup2rarity && randomNumber <= powerup1rarity + powerup2rarity + powerup3rarity)
    {Instantiate(powerup3, gameObject.transform.position, powerup3.transform.rotation);}
      ...
      && randomNumber <= powerup1rarity + powerup2rarity + powerup3rarity + powerup4rarity)
